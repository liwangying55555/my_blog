...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>会生成一个默认密码，记住等会需要使用。</p><figure><img src="`+$+`" alt="mysql初始化" tabindex="0" loading="lazy"><figcaption>mysql初始化</figcaption></figure><h3 id="配置my-cnf配置文件" tabindex="-1"><a class="header-anchor" href="#配置my-cnf配置文件" aria-hidden="true">#</a> 配置my.cnf配置文件</h3><p>因为我们是那个压缩包安装，即离线安装，所以这个my.cnf是需要自己手动配置的</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">vim</span> /etc/my.cnf
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="`+B+'" alt="mysql远程账户权限" tabindex="0" loading="lazy"><figcaption>mysql远程账户权限</figcaption></figure><p>这样就可以使用新建的账号进行远程登录操作。</p>',39))])}const A=t(O,[["render",H],["__file","如何从零开始部署一台服务器【02】.html.vue"]]);export{A as default};
